...
この例の3つのリードは、`Car Buyers`の静的リストに属しており、1081の`id`があります。 リスト ID ](https://developer.adobe.com/marketo-apis/api/mapi#tag/Static-Lists/operation/getLeadsByListIdUsingGET_1) エンドポイントで[Get リードを呼び出して、リスト メンバーを取得します。
