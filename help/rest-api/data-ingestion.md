...
インターフェイスは、人物、カスタムオブジェクト、会社、プログラムメンバー、リスト（静的リスト）の5つのオブジェクトタイプに対して提供されます。 レコード操作は「挿入または更新」のみです。ただし、削除もサポートするプログラムメンバーと、追加および削除をサポートするリストは除きます。
...
取り込みエンドポイントは、個人、カスタムオブジェクト、会社、プログラムメンバーおよびリストに対して使用できます。
