...
失敗した行のレコードと原因を取得するには、[読み込みリード失敗の取得](https://developer.adobe.com/marketo-apis/api/mapi#tag/Bulk-Import-Leads/operation/getImportLeadFailuresUsingGET) エンドポイントを使用して失敗ファイルを取得する必要があります。
